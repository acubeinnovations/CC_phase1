...
echo form_close();?></td>
	...
	<div class="msg"> <?php 
		...
		<div class="box-body table-responsive no-padding trips-table">
			<table class="table table-hover table-bordered" id="trip_tbl">
				<tbody>
					<tr>	
					...
					<tr class="row_click common" style="cursor:pointer;" limited="true">
					   ...
					   <!-- <td><?php echo $customers[$trips[$trip_index]['customer_id']].br();
						...
						<td><?php echo $trips[$trip_index]['pick_up_time']; ?></td>
						 ...
						 ?></td>
					  <td>
					  <?php if($trips[$trip_index]['guest_id']==gINVALID || $trips[$trip_index]['guest_id']==0){echo '';}else{ echo substr($trips[$trip_index]['guest_name'],0,10)."..";
					    } ?>
					  </td>
					 ...
					 <td><?php if($trips[$trip_index]['customer_id']==gINVALID || $trips[$trip_index]['customer_id']==0){echo '';}else{ echo $trips[$trip_index]['customer_name'].br();
					    ...
					    ?></td>
					    <td><?php 
					    if($trips[$trip_index]['vehicle_id']==gINVALID || $trips[$trip_index]['vehicle_id']==0){echo 'Nil'.br();}else{ echo $trips[$trip_index]['registration_number'].br();
					    }
		...
		<div class="modal-body border-2-px box-shadow">
			...
			<fieldset class="body-border">
				...
				<div class="row-source-100-percent-width-with-margin-8">
					<div class="div-with-20-percent-width-with-margin-10">
						...
						<div class="form-group">
						   ...
						   <?php echo form_input(array('name'=>'voucherno','tabindex'=>"1",'class'=>'form-control voucherno','id'=>'voucherno','placeholder'=>'Voucher No')); ?>			
					...
					<div class="div-with-20-percent-width-with-margin-10">
						...
						<div class="form-group">
						   ...
						   <?php echo form_input(array('name'=>'company','tabindex'=>"2",'class'=>'form-control company','id'=>'company','placeholder'=>'Company Name','readonly'=>'true')); ?>			
						</div>
					</div>
					<div class="div-with-20-percent-width-with-margin-10">
						...
						<div class="form-group">
						   ...
						   <?php echo form_input(array('name'=>'customer','tabindex'=>"3",'class'=>'form-control customer','id'=>'customer','placeholder'=>'Customer Name','readonly'=>'true')); ?>			
						</div>
					</div>
					<div class="div-with-20-percent-width-with-margin-10">
				...
				<div class="row-source-100-percent-width-with-margin-8">
					...
					$tbl="taxes";
					$attr=array('tabindex'=>"32");
			echo $this->form_functions->populate_editable_dropdown('taxgroup',$taxes,$class,$tbl,$attr);
