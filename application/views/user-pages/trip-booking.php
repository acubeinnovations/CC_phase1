					...
					<legend class="body-head font-size-18-px">Booking Information</legend>
						<div class="div-with-90-percent-width-and-marigin-5">
							...
							echo form_input(array('name'=>'dropdownlandmark','class'=>'form-control width-96-percent-and-margin-8','id'=>'dropdownlandmark','placeholder'=>'Drop Down Landmark','value'=>$dropdownlandmark));
									...
									<div class="form-group">
									<?php 
									echo form_input(array('name'=>'pickupdatepicker','class'=>'mandatory form-control width-60-percent-with-margin-10 margin-top-less-15','id'=>'pickupdatepicker','placeholder'=>'Pick up Date','value'=>$pickupdatepicker)).form_input(array('name'=>'pickuptimepicker','class'=>'mandatory margin-top-less-15 format-time form-control width-30-percent-with-margin-left-20 margin-top-less-6','id'=>'pickuptimepicker','placeholder'=>'Pick up time ','value'=>$pickuptimepicker));
									...
									<?php 
									echo form_input(array('name'=>'dropdatepicker','class'=>'mandatory form-control width-60-percent-with-margin-10 margin-top-less-10','id'=>'dropdatepicker','placeholder'=>'Drop Date','value'=>$dropdatepicker)).form_input(array('name'=>'droptimepicker','class'=>'mandatory form-control format-time width-30-percent-with-margin-left-20 margin-top-less-10','id'=>'droptimepicker','placeholder'=>'Drop time','value'=>$droptimepicker));
